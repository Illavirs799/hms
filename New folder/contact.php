...
if (isset($_POST['submit'])) {
    ...
    // get hostel manager id
    $query6 = "SELECT * FROM Hostel_Manager WHERE Hostel_id = '$hostel_id'";
    $result6 = mysqli_query($conn, $query6);
    $row6 = mysqli_fetch_assoc($result6);
    $hos_man_id = $row6['Hostel_man_id'];

    // insert message (MATCHES TABLE STRUCTURE)
    $query = "INSERT INTO Message 
(sender_role, sender_id, receiver_role, receiver_id, subject, message, is_read)
VALUES 
('student', '$roll', 'admin', '$hos_man_user', '$subject', '$message')";
//('student', '$roll', 'admin', 1, '$subject', '$message', 0)";
