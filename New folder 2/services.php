	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <?php
                    echo isset($_SESSION['roll']) ? $_SESSION['roll'] : 'Student';
                ?>
                <b class="caret"></b>
            </a>
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					<div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							...
							<div class="mask">
								<a href="hostel-details.php?hostel=A" class="btn btn-primary">Apply for A-Block</a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							...
							<div class="mask">
								<a href="hostel-details.php?hostel=B" class="btn btn-primary">Apply for B-Block</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							...
							<div class="mask">
								<a href="hostel-details.php?hostel=C" class="btn btn-primary">Apply for C-Block</a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view3 view-tenth">
							...
							<div class="mask">
								<a href="hostel-details.php?hostel=D" class="btn btn-primary">Apply for D-Block</a>
							</div>
						</div>
					</div>
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					...
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							...
							<div class="mask">
								<a href="hostel-details.php?hostel=E" class="btn btn-primary">Apply for E-Block</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							...
							<div class="mask">
								<a href="hostel-details.php?hostel=F" class="btn btn-primary">Apply for F-Block</a>
							</div>
						</div>
					</div>
					<!--<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="https://www.vvitguntur.com/" target="_blank">VVIT <span class="display"> Nambur</span></a>
		</div>
